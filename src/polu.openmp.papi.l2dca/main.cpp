...
int tc;						//	thread count
long long int l2_dca;		//	process total L2 data accesses
long long int tot_ns;		//	process total time in nano-seconds

							//	vectors
double *max_vel_v;			//	threads max velocity vector
long long int *l2_dca_v;	//	threads L2 data accesses vector
	...
	double dc)								//	Dirichlet condition
{
	...
	long long int l2_dca_s;					//	L2 data accesses (sequential zone)
