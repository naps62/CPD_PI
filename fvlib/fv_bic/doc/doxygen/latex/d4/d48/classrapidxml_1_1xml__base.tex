\hypertarget{classrapidxml_1_1xml__base}{
\section{rapidxml::xml\_\-base$<$ Ch $>$ Class Template Reference}
\label{d4/d48/classrapidxml_1_1xml__base}\index{rapidxml::xml\_\-base@{rapidxml::xml\_\-base}}
}
...
\hypertarget{classrapidxml_1_1xml__base_a23e7f7aac02d17a0a01afb597e4b966b}{
...
\label{d4/d48/classrapidxml_1_1xml__base_a23e7f7aac02d17a0a01afb597e4b966b}


\subsection{Member Function Documentation}
\hypertarget{classrapidxml_1_1xml__base_a9a09739310469995db078ebd0da3ed45}{
...
\label{d4/d48/classrapidxml_1_1xml__base_a9a09739310469995db078ebd0da3ed45}
...
\end{DoxyReturn}
\hypertarget{classrapidxml_1_1xml__base_ae55060ae958c6e6465d6c8db852ec6ce}{
\index{rapidxml::xml\_\-base@{rapidxml::xml\_\-base}!name@{name}}
\index{name@{name}!rapidxml::xml_base@{rapidxml::xml\_\-base}}
...
\label{d4/d48/classrapidxml_1_1xml__base_ae55060ae958c6e6465d6c8db852ec6ce}
...
\begin{DoxyParams}{Parameters}
\item[{\em name}]Name of node to set. Does not have to be zero terminated. \item[{\em size}]Size of name, in characters. This does not include zero terminator, if one is present. \end{DoxyParams}
\hypertarget{classrapidxml_1_1xml__base_a4611ddc82ac83a527c65606600eb2a0d}{
\index{rapidxml::xml\_\-base@{rapidxml::xml\_\-base}!name@{name}}
\index{name@{name}!rapidxml::xml_base@{rapidxml::xml\_\-base}}
\subsubsection[{name}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Ch = char$>$ void {\bf rapidxml::xml\_\-base}$<$ Ch $>$::name (
\begin{DoxyParamCaption}
...
\label{d4/d48/classrapidxml_1_1xml__base_a4611ddc82ac83a527c65606600eb2a0d}
...
\begin{DoxyParams}{Parameters}
\item[{\em name}]Name of node to set. Must be zero terminated. \end{DoxyParams}
\hypertarget{classrapidxml_1_1xml__base_a7e7f98b3d01e1eab8dc1ca69aad9af84}{
...
\label{d4/d48/classrapidxml_1_1xml__base_a7e7f98b3d01e1eab8dc1ca69aad9af84}
...
\end{DoxyReturn}
\hypertarget{classrapidxml_1_1xml__base_ad96ff6b1e41dab3ff60b9bc4df769a75}{
...
\label{d4/d48/classrapidxml_1_1xml__base_ad96ff6b1e41dab3ff60b9bc4df769a75}
\hypertarget{classrapidxml_1_1xml__base_a7f31ae930f93852830234db1ae59c4c4}{
...
\label{d4/d48/classrapidxml_1_1xml__base_a7f31ae930f93852830234db1ae59c4c4}
Gets node parent. \begin{DoxyReturn}{Returns}
Pointer to parent node, or 0 if there is no parent. 
\end{DoxyReturn}
\hypertarget{classrapidxml_1_1xml__base_adcdaccff61c665f039d9344e447b7445}{
...
\label{d4/d48/classrapidxml_1_1xml__base_adcdaccff61c665f039d9344e447b7445}
...
\end{DoxyReturn}
\hypertarget{classrapidxml_1_1xml__base_a3b183c2db7022a6d30494dd2f0ac11e9}{
\index{rapidxml::xml\_\-base@{rapidxml::xml\_\-base}!value@{value}}
\index{value@{value}!rapidxml::xml_base@{rapidxml::xml\_\-base}}
...
\label{d4/d48/classrapidxml_1_1xml__base_a3b183c2db7022a6d30494dd2f0ac11e9}
...
\begin{DoxyParams}{Parameters}
\item[{\em value}]value of node to set. Does not have to be zero terminated. \item[{\em size}]Size of value, in characters. This does not include zero terminator, if one is present. \end{DoxyParams}
\hypertarget{classrapidxml_1_1xml__base_a81e63ec4bfd2d7ef0a6c2ed49be6e623}{
\index{rapidxml::xml\_\-base@{rapidxml::xml\_\-base}!value@{value}}
\index{value@{value}!rapidxml::xml_base@{rapidxml::xml\_\-base}}
\subsubsection[{value}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Ch = char$>$ void {\bf rapidxml::xml\_\-base}$<$ Ch $>$::value (
\begin{DoxyParamCaption}
...
\label{d4/d48/classrapidxml_1_1xml__base_a81e63ec4bfd2d7ef0a6c2ed49be6e623}
...
\begin{DoxyParams}{Parameters}
\item[{\em value}]Vame of node to set. Must be zero terminated. \end{DoxyParams}
\hypertarget{classrapidxml_1_1xml__base_a9fcf201ed0915ac18dd43b0b5dcfaf32}{
...
\label{d4/d48/classrapidxml_1_1xml__base_a9fcf201ed0915ac18dd43b0b5dcfaf32}
...
\subsubsection[{m\_\-name}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Ch = char$>$ Ch$\ast$ {\bf rapidxml::xml\_\-base}$<$ Ch $>$::{\bf m\_\-name}\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
\subsubsection[{m\_\-name\_\-size}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Ch = char$>$ std::size\_\-t {\bf rapidxml::xml\_\-base}$<$ Ch $>$::{\bf m\_\-name\_\-size}\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
\subsubsection[{m\_\-parent}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Ch = char$>$ {\bf xml\_\-node}$<$Ch$>$$\ast$ {\bf rapidxml::xml\_\-base}$<$ Ch $>$::{\bf m\_\-parent}\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
\subsubsection[{m\_\-value}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Ch = char$>$ Ch$\ast$ {\bf rapidxml::xml\_\-base}$<$ Ch $>$::{\bf m\_\-value}\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
\label{d4/d48/classrapidxml_1_1xml__base_a278a1ea63b0b70219b946cec47fa00ea}
...
\subsubsection[{m\_\-value\_\-size}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Ch = char$>$ std::size\_\-t {\bf rapidxml::xml\_\-base}$<$ Ch $>$::{\bf m\_\-value\_\-size}\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
