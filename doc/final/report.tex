...
\todo[inline]{Animation and flux calculation are out}
...
\todo[inline]{Describe dependencies and the adaptations required to remove them}
...
\todo[inline]{No problem in sending this to an appendix}
