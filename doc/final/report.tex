...
\author{Miguel~Palhas,~\IEEEmembership{pg19808,~MEI}
        and~Pedro Costa,~\IEEEmembership{pg19830, MEI}%
...
\section{Sequential}
\subsection{Original}
\todo[inline]{Explain the original sequential implementation}
...
\todo[inline]{Describe the MPI implementation}
\subsection{Load Balance}
\todo[inline]{Describe how the mesh was partitioned}
\subsection{Limitations}
\todo[inline]{Explain how communication may be a problem, despite of locality issues being favored (smaller pieces of mesh)}

\section{GPU}
\todo[inline]{Describe the CUDA implementation}
\subsection{Load Balance}
\todo[inline]{Explain how the workload is assigned to each thread}
\subsection{Optimizations}
\todo[inline]{Explain source code optimizations, and their impact on performace}
\todo[inline]{Explain how the branches are simple but may still cause warps to diverge and whatever more}
\subsection{Mesh ordering impact}
\todo[inline]{Explain how better ordering of cells/edges should, theoretically, be useful to increase coalesced memory accesses}
\todo[inline]{Talk about the simple optimization attempt (mesh reorder) and its poor (maybe null?) impact on performance}
...
\todo[inline]{Or in my own words: Sum the fuck out of this shit}
