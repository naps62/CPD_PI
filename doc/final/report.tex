\documentclass[9pt,journal,compsoc]{../IEEE/IEEEtran}
...
\newcommand{\aop}{\texttt{Arrays-Of-Pointers}\xspace}
\newcommand{\aos}{\texttt{Arrays-Of-Structs}\xspace}
\newcommand{\soa}{\texttt{Structs-Of-Arrays}\xspace}
...
\input{report/700-finalresults}
\input{report/900-conclusion}
